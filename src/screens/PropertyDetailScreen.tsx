...
const styles = StyleSheet.create({
  ...
  address: { ...typography.h1Page, fontSize: 30, color: colors.textPrimary },
  areaRow: { flexDirection: 'row', alignItems: 'center', marginTop: 6 },
  area: { ...typography.body, color: colors.textSecondary, marginLeft: 6 },
  priceContainer: { alignItems: 'flex-end', padding: 16, borderRadius: 12 },
  priceContainerMobile: { alignItems: 'flex-start', alignSelf: 'flex-start' },
  price: { ...typography.priceLarge, fontSize: 24 },
  pppw: { ...typography.eyebrow, fontSize: 9 },
  priceEstLabel: { ...typography.caption, fontSize: 10, marginTop: 2 },
  infoNote: { ...typography.bodySubtle, fontStyle: 'italic', marginBottom: spacing.xl, marginTop: -spacing.md },
  ...
  statVal: { ...typography.body, fontWeight: '700' as any, color: colors.textPrimary },
  statLab: { ...typography.eyebrow, fontSize: 8, color: colors.textMuted },
  ...
  estimateBadgeText: { ...typography.caption, fontWeight: '700', fontSize: 10 },
  
  section: { marginBottom: 32 },
  sectionTitle: { ...typography.h2Section, fontSize: 20, marginBottom: 12 },
  ...
  landlordHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 },
  landlordHeaderMobile: { flexDirection: 'column', gap: 12 },
  landlordLabel: { ...typography.eyebrow, fontSize: 9 },
  landlordName: { ...typography.h3Card, fontSize: 18, marginTop: 4 },
  verifiedBadge: { 
    flexDirection: 'row', 
    alignItems: 'center', 
    backgroundColor: colors.white, 
  ...
  reviewLink: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 12 },
  reviewLinkText: { ...typography.bodySmall, fontWeight: '700' }
});
