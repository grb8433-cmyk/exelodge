...
const FAQ = [
  ...
  { q: "What do I do if I am being harassed by my landlord?", a: "Harassment is a criminal offence. Keep a log of all incidents. You can contact the police or Exeter City Council for help with illegal eviction and harassment.", link: 'https://www.gov.uk/private-renting-evictions/harassment-and-illegal-evictions' },
  { q: "What do I do if my housemates aren't paying their rent?", a: "If you have a 'joint and several' tenancy, you are all responsible for the total rent. The landlord can ask any tenant (or their guarantor) for the missing money. Communicate with your housemates and the Student Guild immediately.", link: 'https://www.exeterguild.com/advice' },
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
      ...
      <View style={[styles.pageHeader, !desktop && styles.pageHeaderMobile]}>
        ...
        <Text style={[styles.pageDesc, !desktop && { fontSize: 13 }]}>
          A comprehensive guide to UK legislation and student-specific advice for the Exeter market.
        </Text>
      </View>
      ...
      <View style={[styles.content, !desktop && styles.contentMobile]}>
        ...
        <View style={[styles.disclaimer, !desktop && styles.disclaimerMobile]}>
          ...
          <Text style={styles.disclaimerText}>
            ...
            contact Exeter Guild Advice or Citizens Advice.
          </Text>
        </View>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  headerBadgeText: { fontFamily, fontSize: 11, fontWeight: '700' as any, color: colors.primary, letterSpacing: 0.3 },
